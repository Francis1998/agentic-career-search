# HireVue Source Guide

![HireVue discovery flow](../../assets/demo/hirevue-source.gif)

Use this guide when wiring a public HireVue careers board into
...
HireVue provides hiring and recruiting experiences used by employers to
...
curl -X POST localhost:8000/source-configs \
  ...
  -d '{
    "name": "acme-hirevue",
    "source_type": "hirevue",
    "base_url": "https://acme.hirevue.com/jobs/"
  }'
```
...
- Public HTML only — no authenticated HireVue APIs.
