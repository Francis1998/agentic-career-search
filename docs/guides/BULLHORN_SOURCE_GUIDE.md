# Bullhorn Source Guide

![Bullhorn discovery flow](../../assets/demo/bullhorn-source.gif)

Use this guide when wiring a public Bullhorn careers board into
...
Bullhorn (`*.bullhornstaffing.com`) is a major ATS/HR platform. Public boards
...
curl -X POST localhost:8000/source-configs \
  ...
  -d '{
    ...
    "base_url": "https://acme.bullhornstaffing.com"
  }'
```
...
| Jobs | `/jobs/48291` |
| Job | `/Job/48291` |
| Careers | `/careers/48291` |
| Careers/Job | `/careers/job/48291` |
| Position | `/position/48291` |
...
- Public careers pages only — no authenticated Bullhorn APIs.
- Outbound User-Agent comes from settings.
- Parsing stops at `max_jobs`; no unbounded crawl.

See ADR-115 for the design decision.
