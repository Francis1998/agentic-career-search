# ADR-178: Levels.fyi Public Careers Source Adapter
...
Levels.fyi publishes career boards whose public listings commonly link to
detail pages under /jobs/{id}, /job/{id}, /roles/{id}, /openings/{id}, /levels/{id}.
...
Add a `LevelsfyiAdapter` (`source_type = "levelsfyi"`) that:

1. Recognises the URL shapes /jobs/{id}, /job/{id}, /roles/{id}, /openings/{id}, /levels/{id}.
...
- Levels.fyi public recruiting boards are covered without authenticated
