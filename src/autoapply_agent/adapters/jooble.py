"""Jooble public careers site adapter.

Jooble public recruiting boards expose listing pages whose postings
render as anchors. Detail hrefs commonly follow the shapes documented in
ADR-182. This adapter recognises those posting URLs while excluding board
...
class JoobleAdapter(CareerSourceAdapter):
    """Fetch jobs from public Jooble careers site pages."""
    ...
    async def fetch_jobs(
        ...
        """Fetch and parse Jooble jobs.

        Args:
            base_url: Jooble careers site URL.
    ...
    def _parse_html(self, base_url: str, html: str, max_jobs: int) -> list[JobCandidate]:
        """Parse Jooble careers HTML into job candidates.
    ...
    def _accepts_detail_candidate(
        ...
        """Report whether a path segment is a valid Jooble posting id."""
    ...
    def _is_job_id(candidate: str) -> bool:
        """Report whether a path segment looks like a Jooble job post id."""
    ...
    def _anchor_title(cls, anchor: object) -> str | None:
        """Resolve a posting title from a Jooble anchor."""
    ...
    def _extract_location(anchor: object) -> str | None:
        """Resolve a posting location from Jooble anchor metadata or markup."""
