"""Totaljobs public careers site adapter.

Totaljobs public recruiting boards expose listing pages whose postings
render as anchors. Detail hrefs commonly follow the shapes documented in
ADR-194. This adapter recognises those posting URLs while excluding board
...
_JOB_PREFIX = "job"
_JOBS_PREFIX = "jobs"
_JOB_VACANCY_PREFIX = "job-vacancy"
...
_COMPOUND_PREFIXES = (("uk", "job"),)


class TotaljobsAdapter(CareerSourceAdapter):
    """Fetch jobs from public Totaljobs careers site pages."""

    adapter_name = "totaljobs"
