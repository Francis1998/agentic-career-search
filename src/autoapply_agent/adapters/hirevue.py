"""HireVue public careers site adapter.

HireVue-hosted public recruiting boards expose listing pages whose postings
render as anchors. Detail hrefs commonly follow the shapes documented in
ADR-147. This adapter recognises those posting URLs while excluding board
...
class HireVueAdapter(CareerSourceAdapter):
    """Fetch jobs from public HireVue careers site pages."""

    adapter_name = "hirevue"
    ...
    async def fetch_jobs(
        ...
        """Fetch and parse HireVue jobs.

        Args:
            base_url: HireVue careers site URL.
    ...
    def _parse_html(self, base_url: str, html: str, max_jobs: int) -> list[JobCandidate]:
        """Parse HireVue careers HTML into job candidates.
    ...
    def _accepts_detail_candidate(
        ...
        """Report whether a path segment is a valid HireVue posting id."""
    ...
    def _is_job_id(candidate: str) -> bool:
        """Report whether a path segment looks like a HireVue job post id."""
    ...
    def _anchor_title(cls, anchor: object) -> str | None:
        """Resolve a posting title from a HireVue anchor."""
    ...
    def _extract_location(anchor: object) -> str | None:
        """Resolve a posting location from HireVue anchor metadata or markup."""
