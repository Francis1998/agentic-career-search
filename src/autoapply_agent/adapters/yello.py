"""Yello public careers site adapter.

Yello-hosted public recruiting boards expose listing pages whose postings
render as anchors. Detail hrefs commonly follow the shapes documented in
ADR-149. This adapter recognises those posting URLs while excluding board
...
class YelloAdapter(CareerSourceAdapter):
    """Fetch jobs from public Yello careers site pages."""
    ...
    async def fetch_jobs(
        ...
        """Fetch and parse Yello jobs.

        Args:
            base_url: Yello careers site URL.
    ...
    def _parse_html(self, base_url: str, html: str, max_jobs: int) -> list[JobCandidate]:
        """Parse Yello careers HTML into job candidates.
    ...
    def _accepts_detail_candidate(
        ...
        """Report whether a path segment is a valid Yello posting id."""
    ...
    def _is_job_id(candidate: str) -> bool:
        """Report whether a path segment looks like a Yello job post id."""
    ...
    def _anchor_title(cls, anchor: object) -> str | None:
        """Resolve a posting title from a Yello anchor."""
    ...
    def _extract_location(anchor: object) -> str | None:
        """Resolve a posting location from Yello anchor metadata or markup."""
