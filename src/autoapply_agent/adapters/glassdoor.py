"""Glassdoor public careers site adapter.

Glassdoor public recruiting boards expose listing pages whose postings
render as anchors. Detail hrefs commonly follow the shapes documented in
ADR-186. This adapter recognises those posting URLs while excluding board
...
_REVIEWS_PREFIX = "reviews"
_JOBS_PREFIX = "jobs"
_JOB_LISTING_PREFIX = "job-listing"
...
class GlassdoorAdapter(CareerSourceAdapter):
    """Fetch jobs from public Glassdoor careers site pages."""

    adapter_name = "glassdoor"
