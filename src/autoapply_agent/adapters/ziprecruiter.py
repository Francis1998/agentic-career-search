"""ZipRecruiter public careers site adapter.

ZipRecruiter public recruiting boards expose listing pages whose postings
render as anchors. Detail hrefs commonly follow the shapes documented in
ADR-183. This adapter recognises those posting URLs while excluding board
...
class ZiprecruiterAdapter(CareerSourceAdapter):
    """Fetch jobs from public ZipRecruiter careers site pages."""

    adapter_name = "ziprecruiter"
    ...
    async def fetch_jobs(
        ...
        """Fetch and parse ZipRecruiter jobs.

        Args:
            base_url: ZipRecruiter careers site URL.
    ...
    def _parse_html(self, base_url: str, html: str, max_jobs: int) -> list[JobCandidate]:
        """Parse ZipRecruiter careers HTML into job candidates.
    ...
    def _accepts_detail_candidate(
        ...
        """Report whether a path segment is a valid ZipRecruiter posting id."""
    ...
    def _is_job_id(candidate: str) -> bool:
        """Report whether a path segment looks like a ZipRecruiter job post id."""
    ...
    def _anchor_title(cls, anchor: object) -> str | None:
        """Resolve a posting title from a ZipRecruiter anchor."""
    ...
    def _extract_location(anchor: object) -> str | None:
        """Resolve a posting location from ZipRecruiter anchor metadata or markup."""
