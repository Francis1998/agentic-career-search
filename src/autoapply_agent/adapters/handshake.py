"""Handshake public careers site adapter.

Handshake public recruiting boards expose listing pages whose postings
render as anchors. Detail hrefs commonly follow the shapes documented in
ADR-191. This adapter recognises those posting URLs while excluding board
...
_JOBS_PREFIX = "jobs"
_JOB_SEARCH_PREFIX = "job-search"
_POSTINGS_PREFIX = "postings"
_INTERNSHIP_PREFIX = "internship"
...
_COMPOUND_PREFIXES = (("edu", "jobs"),)


class HandshakeAdapter(CareerSourceAdapter):
    """Fetch jobs from public Handshake careers site pages."""
