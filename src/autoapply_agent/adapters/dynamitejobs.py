"""Dynamitejobs public careers site adapter.

Dynamitejobs public recruiting boards expose listing pages whose postings
render as anchors. Detail hrefs commonly follow the shapes documented in
ADR-162. This adapter recognises those posting URLs while excluding board
...
class DynamitejobsAdapter(CareerSourceAdapter):
    """Fetch jobs from public Dynamitejobs careers site pages."""

    adapter_name = "dynamitejobs"
    ...
    async def fetch_jobs(
        ...
        """Fetch and parse Dynamitejobs jobs.

        Args:
            base_url: Dynamitejobs careers site URL.
    ...
    def _parse_html(self, base_url: str, html: str, max_jobs: int) -> list[JobCandidate]:
        """Parse Dynamitejobs careers HTML into job candidates.
    ...
    def _accepts_detail_candidate(
        ...
        """Report whether a path segment is a valid Dynamitejobs posting id."""
    ...
    def _is_job_id(candidate: str) -> bool:
        """Report whether a path segment looks like a Dynamitejobs job post id."""
    ...
    def _anchor_title(cls, anchor: object) -> str | None:
        """Resolve a posting title from a Dynamitejobs anchor."""
    ...
    def _extract_location(anchor: object) -> str | None:
        """Resolve a posting location from Dynamitejobs anchor metadata or markup."""
