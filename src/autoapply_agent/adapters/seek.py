"""Seek public careers site adapter.

Seek public recruiting boards expose listing pages whose postings
render as anchors. Detail hrefs commonly follow the shapes documented in
ADR-192. This adapter recognises those posting URLs while excluding board
...
_JOB_PREFIX = "job"
_JOBS_PREFIX = "jobs"
_LISTED_JOB_PREFIX = "listed-job"
_JOBSEARCH_PREFIX = "jobsearch"
...
_COMPOUND_PREFIXES = (("au", "job"),)


class SeekAdapter(CareerSourceAdapter):
    """Fetch jobs from public Seek careers site pages."""
