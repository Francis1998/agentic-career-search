"""Monster public careers site adapter.

Monster public recruiting boards expose listing pages whose postings
render as anchors. Detail hrefs commonly follow the shapes documented in
ADR-189. This adapter recognises those posting URLs while excluding board
...
_JOB_OPENINGS_PREFIX = "job-openings"
_JOBS_PREFIX = "jobs"
_CAREER_PREFIX = "career"
_DETAIL_PREFIXES = frozenset(
    {
        _JOB_OPENINGS_PREFIX,
        _JOBS_PREFIX,
        _CAREER_PREFIX,
    }
)
...
class MonsterAdapter(CareerSourceAdapter):
    """Fetch jobs from public Monster careers site pages."""

    adapter_name = "monster"
