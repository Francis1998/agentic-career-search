"""4 Day Week public careers site adapter.

4 Day Week public recruiting boards expose listing pages whose postings
render as anchors. Detail hrefs commonly follow the shapes documented in
ADR-171. This adapter recognises those posting URLs while excluding board
...
class FourdayweekAdapter(CareerSourceAdapter):
    """Fetch jobs from public 4 Day Week careers site pages."""

    adapter_name = "fourdayweek"
    ...
    async def fetch_jobs(
        ...
        """Fetch and parse 4 Day Week jobs.

        Args:
            base_url: 4 Day Week careers site URL.
    ...
    def _parse_html(self, base_url: str, html: str, max_jobs: int) -> list[JobCandidate]:
        """Parse 4 Day Week careers HTML into job candidates.
    ...
    def _accepts_detail_candidate(
        ...
        """Report whether a path segment is a valid 4 Day Week posting id."""
    ...
    def _is_job_id(candidate: str) -> bool:
        """Report whether a path segment looks like a 4 Day Week job post id."""
    ...
    def _anchor_title(cls, anchor: object) -> str | None:
        """Resolve a posting title from a 4 Day Week anchor."""
    ...
    def _extract_location(anchor: object) -> str | None:
        """Resolve a posting location from 4 Day Week anchor metadata or markup."""
