"""Jobgether public careers site adapter.

Jobgether public recruiting boards expose listing pages whose postings
render as anchors. Detail hrefs commonly follow the shapes documented in
ADR-168. This adapter recognises those posting URLs while excluding board
...
class JobgetherAdapter(CareerSourceAdapter):
    """Fetch jobs from public Jobgether careers site pages."""

    adapter_name = "jobgether"
    ...
    async def fetch_jobs(
        ...
        """Fetch and parse Jobgether jobs.

        Args:
            base_url: Jobgether careers site URL.
    ...
    def _parse_html(self, base_url: str, html: str, max_jobs: int) -> list[JobCandidate]:
        """Parse Jobgether careers HTML into job candidates.
    ...
    def _accepts_detail_candidate(
        ...
        """Report whether a path segment is a valid Jobgether posting id."""
    ...
    def _is_job_id(candidate: str) -> bool:
        """Report whether a path segment looks like a Jobgether job post id."""
    ...
    def _anchor_title(cls, anchor: object) -> str | None:
        """Resolve a posting title from a Jobgether anchor."""
    ...
    def _extract_location(anchor: object) -> str | None:
        """Resolve a posting location from Jobgether anchor metadata or markup."""
