"""AI Jobs public careers site adapter.

AI Jobs public recruiting boards expose listing pages whose postings
render as anchors. Detail hrefs commonly follow the shapes documented in
ADR-172. This adapter recognises those posting URLs while excluding board
...
class AijobsAdapter(CareerSourceAdapter):
    """Fetch jobs from public AI Jobs careers site pages."""
    ...
    async def fetch_jobs(
        ...
        """Fetch and parse AI Jobs jobs.

        Args:
            base_url: AI Jobs careers site URL.
    ...
    def _parse_html(self, base_url: str, html: str, max_jobs: int) -> list[JobCandidate]:
        """Parse AI Jobs careers HTML into job candidates.
    ...
    def _accepts_detail_candidate(
        ...
        """Report whether a path segment is a valid AI Jobs posting id."""
    ...
    def _is_job_id(candidate: str) -> bool:
        """Report whether a path segment looks like a AI Jobs job post id."""
    ...
    def _anchor_title(cls, anchor: object) -> str | None:
        """Resolve a posting title from a AI Jobs anchor."""
    ...
    def _extract_location(anchor: object) -> str | None:
        """Resolve a posting location from AI Jobs anchor metadata or markup."""
