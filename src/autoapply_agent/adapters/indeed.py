"""Indeed public careers site adapter.

Indeed public recruiting boards expose listing pages whose postings
render as anchors. Detail hrefs commonly follow the shapes documented in
ADR-188. This adapter recognises those posting URLs while excluding board
...
_COMPOUND_PREFIXES = (("rc", "clk"), ("m", "jobs"))


class IndeedAdapter(CareerSourceAdapter):
    """Fetch jobs from public Indeed careers site pages."""
