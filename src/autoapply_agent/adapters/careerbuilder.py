"""CareerBuilder public careers site adapter.

CareerBuilder public recruiting boards expose listing pages whose postings
render as anchors. Detail hrefs commonly follow the shapes documented in
ADR-190. This adapter recognises those posting URLs while excluding board
...
_JOB_PREFIX = "job"
_JOBS_PREFIX = "jobs"
_CAREER_JOBS_PREFIX = "career-jobs"
...
class CareerbuilderAdapter(CareerSourceAdapter):
    """Fetch jobs from public CareerBuilder careers site pages."""

    adapter_name = "careerbuilder"
