"""AngelList (Wellfound) public careers site adapter.

AngelList public recruiting boards expose listing pages whose postings
render as anchors. Detail hrefs commonly follow the shapes documented in
ADR-187. This adapter recognises those posting URLs while excluding board
...
class AngellistAdapter(CareerSourceAdapter):
    """Fetch jobs from public AngelList careers site pages."""

    adapter_name = "angellist"
