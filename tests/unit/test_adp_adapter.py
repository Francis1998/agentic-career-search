"""Unit tests for the ADP Recruiting careers site adapter."""
...
def test_adp_parser_extracts_jobs() -> None:
    """ADP parser should extract posting fields and skip nav/apply links."""

    adapter = AdpAdapter(user_agent="test-agent")
    jobs = adapter._parse_html(
        "https://acme.adp.com/jobs/",
        ADP_SAMPLE_HTML,
        max_jobs=10,
    )
    ...
    assert by_title["Software Engineer"].raw == {"source": "adp"}
...
def test_adp_parser_ignores_non_posting_links() -> None:
    """Only ADP Recruiting detail links should become candidates."""
...
def test_adp_parser_falls_back_to_title_attribute() -> None:
...
def test_adp_parser_respects_max_jobs() -> None:
...
def test_adp_parser_returns_empty_for_non_positive_max_jobs() -> None:
...
def test_adp_location_is_scoped_to_its_posting() -> None:
    ...
    <div class="job">
      <a href="/requisitions/22222"><h4>Second Role</h4></a>
