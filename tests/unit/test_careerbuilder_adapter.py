"""Unit tests for the CareerBuilder careers site adapter."""
...
_B_PATH = "/jobs/56213"
_C = "62324"
_C_PATH = "/jobseeker/jobs/62324"
_D = "73435"
_D_PATH = "/share/job/73435"
_E = "84546"
_E_PATH = "/career-jobs/84546"

CAREERBUILDER_SAMPLE_HTML = """
<html>
  <body>
    <section class="listings">
      <article class="job">
        <a href="/job/49102" class="heading" data-location="Lisbon">
          Software Engineer
        </a>
      </article>
      <article class="job">
      ...
      <article class="job">
        <a href="/jobseeker/jobs/62324" class="heading" data-job-location="Remote">
          Implementation Engineer
        </a>
      </article>
      <article class="job">
        <a href="/share/job/73435" class="heading" data-location="Berlin">
          Data Engineer
        </a>
      </article>
      <article class="job">
        <a href="/career-jobs/84546" class="heading" data-location="Tokyo">
          Product Manager
        </a>
      </article>
    </section>
    <a href="/job">Index</a>
    <a href="/jobs">Index</a>
    <a href="/jobseeker/jobs">Index</a>
    <a href="/share/job">Index</a>
    <a href="/career-jobs">Index</a>
    <a href="/job/49102/apply">Apply</a>
...
def test_careerbuilder_parser_extracts_jobs() -> None:
    """CareerBuilder parser should extract posting fields and skip nav/apply links."""

    adapter = CareerbuilderAdapter(user_agent="test-agent")
    ...
    assert by_title["Software Engineer"].raw == {"source": "careerbuilder"}
...
def test_careerbuilder_parser_ignores_non_posting_links() -> None:
    """Only CareerBuilder detail links should become candidates."""
...
def test_careerbuilder_parser_falls_back_to_title_attribute() -> None:
...
def test_careerbuilder_parser_respects_max_jobs() -> None:
...
def test_careerbuilder_parser_returns_empty_for_non_positive_max_jobs() -> None:
...
def test_careerbuilder_parser_uses_remote_flag() -> None:
    ...
    """
    jobs = adapter._parse_html("https://www.careerbuilder.com/jobs", html, max_jobs=10)
    assert len(jobs) == 1
