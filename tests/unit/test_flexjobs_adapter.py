"""Unit tests for the FlexJobs careers site adapter."""
...
_JOB_A = "48291"
_PATH_A = "/search/48291"
_JOB_B = "55902"
_PATH_B = "/flex-jobs/55902"
_JOB_C = "61033"
_PATH_C = "/remote-job/61033"
_JOB_D = "72044"
_PATH_D = "/jobs/72044"
_JOB_E = "83055"
_PATH_E = "/job/83055"

FLEXJOBS_SAMPLE_HTML = """
<html>
  <body>
    <section class="listings">
      <article class="job">
        <a href="/search/48291" class="heading" data-location="Lisbon">
          Software Engineer
        </a>
      </article>
      <article class="job">
        <a href="/flex-jobs/55902" class="heading" data-location="Bali">
          Platform Engineer
        </a>
      </article>
      <article class="job">
        <a href="/remote-job/61033" class="heading" data-job-location="Remote">
    ...
    <a href="/flex-jobs">Index</a>
    <a href="/remote-job">Index</a>
    <a href="/jobs">Index</a>
    <a href="/job">Index</a>
    <a href="/search/48291/apply">Apply</a>
...
def test_flexjobs_parser_extracts_jobs() -> None:
    """FlexJobs parser should extract posting fields and skip nav/apply links."""

    adapter = FlexjobsAdapter(user_agent="test-agent")
    ...
    assert by_title["Software Engineer"].raw == {"source": "flexjobs"}
...
def test_flexjobs_parser_ignores_non_posting_links() -> None:
    """Only FlexJobs detail links should become candidates."""
    ...
    <a href="/search/{_JOB_A}/login">Login</a>
    <a href="/remote-job/{_JOB_C}/apply">Apply role</a>
    <a href="/about">About</a>
...
def test_flexjobs_parser_falls_back_to_title_attribute() -> None:
...
def test_flexjobs_parser_respects_max_jobs() -> None:
...
def test_flexjobs_parser_returns_empty_for_non_positive_max_jobs() -> None:
    """Non-positive max_jobs should short-circuit to an empty list."""

    adapter = FlexjobsAdapter(user_agent="test-agent")
    assert (
        adapter._parse_html("https://www.flexjobs.com/search", FLEXJOBS_SAMPLE_HTML, max_jobs=0)
        == []
    )
    assert (
        adapter._parse_html("https://www.flexjobs.com/search", FLEXJOBS_SAMPLE_HTML, max_jobs=-1)
        == []
    )


def test_flexjobs_parser_uses_remote_flag() -> None:
    ...
    """
    jobs = adapter._parse_html("https://www.flexjobs.com/search", html, max_jobs=10)
    assert len(jobs) == 1
