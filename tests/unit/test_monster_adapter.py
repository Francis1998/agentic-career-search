"""Unit tests for the Monster careers site adapter."""
...
_A = "49102"
_A_PATH = "/jobs/job/49102"
_B = "56213"
_B_PATH = "/job-openings/56213"
_C = "62324"
_C_PATH = "/jobs/62324"
_D = "73435"
_D_PATH = "/career/73435"
_E = "84546"
_E_PATH = "/m/job/84546"
...
<html>
  <body>
    <section class="listings">
      <article class="job">
        <a href="/jobs/job/49102" class="heading" data-location="Lisbon">
          Software Engineer
        </a>
      </article>
      <article class="job">
        <a href="/job-openings/56213" class="heading" data-location="Bali">
          Platform Engineer
        </a>
      </article>
      <article class="job">
      ...
      <article class="job">
        <a href="/career/73435" class="heading" data-location="Berlin">
          Data Engineer
        </a>
      </article>
      <article class="job">
        <a href="/m/job/84546" class="heading" data-location="Tokyo">
          Product Manager
        </a>
      </article>
    </section>
    <a href="/jobs/job">Index</a>
    <a href="/job-openings">Index</a>
    <a href="/jobs">Index</a>
    <a href="/career">Index</a>
    <a href="/m/job">Index</a>
    <a href="/jobs/job/49102/apply">Apply</a>
...
def test_monster_parser_extracts_jobs() -> None:
    """Monster parser should extract posting fields and skip nav/apply links."""

    adapter = MonsterAdapter(user_agent="test-agent")
    ...
    assert by_title["Software Engineer"].raw == {"source": "monster"}
...
def test_monster_parser_ignores_non_posting_links() -> None:
    """Only Monster detail links should become candidates."""
    ...
    <a href="/jobs/job/{_A}/login">Login</a>
...
def test_monster_parser_falls_back_to_title_attribute() -> None:
...
def test_monster_parser_respects_max_jobs() -> None:
...
def test_monster_parser_returns_empty_for_non_positive_max_jobs() -> None:
    """Non-positive max_jobs should short-circuit to an empty list."""

    adapter = MonsterAdapter(user_agent="test-agent")
    assert (
        adapter._parse_html("https://www.monster.com/jobs", MONSTER_SAMPLE_HTML, max_jobs=0) == []
    )
    assert (
        adapter._parse_html("https://www.monster.com/jobs", MONSTER_SAMPLE_HTML, max_jobs=-1) == []
    )


def test_monster_parser_uses_remote_flag() -> None:
    ...
    """
    jobs = adapter._parse_html("https://www.monster.com/jobs", html, max_jobs=10)
    assert len(jobs) == 1
