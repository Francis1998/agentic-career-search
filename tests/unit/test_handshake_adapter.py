"""Unit tests for the Handshake careers site adapter."""
...
_A_PATH = "/jobs/49102"
_B = "56213"
_B_PATH = "/job-search/56213"
_C = "62324"
_C_PATH = "/postings/62324"
_D = "73435"
_D_PATH = "/edu/jobs/73435"
_E = "84546"
_E_PATH = "/internship/84546"

HANDSHAKE_SAMPLE_HTML = """
<html>
  <body>
    <section class="listings">
      ...
      <article class="job">
        <a href="/job-search/56213" class="heading" data-location="Bali">
          Platform Engineer
        </a>
      </article>
      <article class="job">
        <a href="/postings/62324" class="heading" data-job-location="Remote">
          Implementation Engineer
        </a>
      </article>
      <article class="job">
        <a href="/edu/jobs/73435" class="heading" data-location="Berlin">
          Data Engineer
        </a>
      </article>
      <article class="job">
        <a href="/internship/84546" class="heading" data-location="Tokyo">
          Product Manager
        </a>
      </article>
    </section>
    <a href="/jobs">Index</a>
    <a href="/job-search">Index</a>
    <a href="/postings">Index</a>
    <a href="/edu/jobs">Index</a>
    <a href="/internship">Index</a>
...
def test_handshake_parser_extracts_jobs() -> None:
    """Handshake parser should extract posting fields and skip nav/apply links."""

    adapter = HandshakeAdapter(user_agent="test-agent")
    ...
    assert by_title["Software Engineer"].raw == {"source": "handshake"}
...
def test_handshake_parser_ignores_non_posting_links() -> None:
    """Only Handshake detail links should become candidates."""
...
def test_handshake_parser_falls_back_to_title_attribute() -> None:
...
def test_handshake_parser_respects_max_jobs() -> None:
...
def test_handshake_parser_returns_empty_for_non_positive_max_jobs() -> None:
...
def test_handshake_parser_uses_remote_flag() -> None:
    ...
    """
    jobs = adapter._parse_html("https://joinhandshake.com/jobs", html, max_jobs=10)
    assert len(jobs) == 1
