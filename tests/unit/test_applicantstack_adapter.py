"""Unit tests for the ApplicantStack careers site adapter."""
...
<html>
  <body>
    ...
    <a href="/postings">Postings index</a>
...
def test_applicantstack_parser_extracts_jobs() -> None:
    """ApplicantStack parser should extract posting fields and skip nav/apply links."""

    adapter = ApplicantStackAdapter(user_agent="test-agent")
    jobs = adapter._parse_html(
        "https://acme.applicantstack.com/x/search",
        APPLICANTSTACK_SAMPLE_HTML,
        max_jobs=10,
    )
    ...
    assert by_title["Software Engineer"].raw == {"source": "applicantstack"}
...
def test_applicantstack_parser_ignores_non_posting_links() -> None:
    """Only ApplicantStack detail links should become candidates."""
...
def test_applicantstack_parser_falls_back_to_title_attribute() -> None:
...
def test_applicantstack_parser_honors_zero_max_jobs() -> None:
...
def test_applicantstack_location_is_scoped_to_its_posting() -> None:
