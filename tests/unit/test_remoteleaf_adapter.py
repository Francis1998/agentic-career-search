"""Unit tests for the RemoteLeaf careers site adapter."""
...
_JOB_A = "48291"
_PATH_A = "/remote/48291"
_JOB_B = "55902"
_PATH_B = "/leaf-jobs/55902"
_JOB_C = "61033"
...
REMOTELEAF_SAMPLE_HTML = """
<html>
  <body>
    <section class="listings">
      <article class="job">
        <a href="/remote/48291" class="heading" data-location="Lisbon">
          Software Engineer
        </a>
      </article>
      <article class="job">
        <a href="/leaf-jobs/55902" class="heading" data-location="Bali">
          Platform Engineer
        </a>
      </article>
      <article class="job">
    ...
    <a href="/remote">Index</a>
    <a href="/leaf-jobs">Index</a>
    <a href="/positions">Index</a>
    <a href="/jobs">Index</a>
    <a href="/job">Index</a>
    <a href="/remote/48291/apply">Apply</a>
...
def test_remoteleaf_parser_extracts_jobs() -> None:
    """RemoteLeaf parser should extract posting fields and skip nav/apply links."""

    adapter = RemoteleafAdapter(user_agent="test-agent")
    jobs = adapter._parse_html(
        "https://remoteleaf.com/jobs",
        REMOTELEAF_SAMPLE_HTML,
        max_jobs=10,
    )
    ...
    assert by_title["Software Engineer"].raw == {"source": "remoteleaf"}
...
def test_remoteleaf_parser_ignores_non_posting_links() -> None:
    """Only RemoteLeaf detail links should become candidates."""
    ...
    <a href="/remote/{_JOB_A}/login">Login</a>
    <a href="/positions/{_JOB_C}/apply">Apply role</a>
    <a href="/about">About</a>
...
def test_remoteleaf_parser_falls_back_to_title_attribute() -> None:
...
def test_remoteleaf_parser_respects_max_jobs() -> None:
...
def test_remoteleaf_parser_returns_empty_for_non_positive_max_jobs() -> None:
    """Non-positive max_jobs should short-circuit to an empty list."""

    adapter = RemoteleafAdapter(user_agent="test-agent")
    assert (
        adapter._parse_html("https://remoteleaf.com/jobs", REMOTELEAF_SAMPLE_HTML, max_jobs=0) == []
    )
    assert (
        adapter._parse_html("https://remoteleaf.com/jobs", REMOTELEAF_SAMPLE_HTML, max_jobs=-1)
        == []
    )


def test_remoteleaf_parser_uses_remote_flag() -> None:
    ...
    """
    jobs = adapter._parse_html("https://remoteleaf.com/jobs", html, max_jobs=10)
    assert len(jobs) == 1
