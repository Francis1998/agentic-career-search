"""Unit tests for the Authentic Jobs careers site adapter."""
...
_JOB_A = "48291"
_PATH_A = "/postings/48291"
_JOB_B = "55902"
_PATH_B = "/listing/55902"
_JOB_C = "61033"
_PATH_C = "/opportunities/61033"
_JOB_D = "72044"
_PATH_D = "/jobs/72044"
_JOB_E = "83055"
_PATH_E = "/job/83055"

AUTHENTICJOBS_SAMPLE_HTML = """
<html>
  <body>
    <section class="listings">
      <article class="job">
        <a href="/postings/48291" class="heading" data-location="Lisbon">
          Software Engineer
        </a>
      </article>
      <article class="job">
        <a href="/listing/55902" class="heading" data-location="Bali">
          Platform Engineer
        </a>
      </article>
      <article class="job">
        <a href="/opportunities/61033" class="heading" data-job-location="Remote">
    ...
    <a href="/jobs">Index</a>
    <a href="/job">Index</a>
    <a href="/postings/48291/apply">Apply</a>
...
def test_authenticjobs_parser_extracts_jobs() -> None:
    """Authentic Jobs parser should extract posting fields and skip nav/apply links."""

    adapter = AuthenticjobsAdapter(user_agent="test-agent")
    ...
    assert by_title["Software Engineer"].raw == {"source": "authenticjobs"}
...
def test_authenticjobs_parser_ignores_non_posting_links() -> None:
    """Only Authentic Jobs detail links should become candidates."""
    ...
    <a href="/postings/{_JOB_A}/login">Login</a>
    <a href="/opportunities/{_JOB_C}/apply">Apply role</a>
    <a href="/about">About</a>
...
def test_authenticjobs_parser_falls_back_to_title_attribute() -> None:
...
def test_authenticjobs_parser_respects_max_jobs() -> None:
...
def test_authenticjobs_parser_returns_empty_for_non_positive_max_jobs() -> None:
    """Non-positive max_jobs should short-circuit to an empty list."""

    adapter = AuthenticjobsAdapter(user_agent="test-agent")
    assert (
        adapter._parse_html("https://authenticjobs.com/jobs", AUTHENTICJOBS_SAMPLE_HTML, max_jobs=0)
        == []
    )
    assert (
        adapter._parse_html(
            "https://authenticjobs.com/jobs", AUTHENTICJOBS_SAMPLE_HTML, max_jobs=-1
        )
        == []
    )


def test_authenticjobs_parser_uses_remote_flag() -> None:
    ...
    """
    jobs = adapter._parse_html("https://authenticjobs.com/jobs", html, max_jobs=10)
    assert len(jobs) == 1
